...
let articule = document.querySelector("article")
let cloneArticule = articule.cloneNode(true)
let section = document.querySelector("section")

cloneArticule.innerHTML = "New section"
// section.appendChild(cloneArticule)

// ante de que empiece 
// section.insertAdjacentElement("beforebegin", cloneArticule) 

// antes de que acabe 

// section.insertAdjacentElement("beforeend", cloneArticule)

// depues de que empiece la etiqueta
// section.insertAdjacentElement("afterbegin", cloneArticule)

// despues de la etiqueta
//  section.insertAdjacentElement("afterend", cloneArticule) 
// - Eliminar elementos
